...
const en: Dict = {
  ...
  "ti.barTipMood": "{n} of {size} took part · mood {mood}/5",
  "ti.barTipParticipation": "{n} of {size} took part",
  "ti.barTipResponses": "{n} responses",
  ...
  "ti.step1": "Gathering your past retros",
  "ti.step2": "Tracking the trajectory",
  "ti.step3": "Spotting recurring themes",
  "ti.step4": "Writing the team pulse",
  ...
  "rp.stop": "Stop",
  "rp.generatingTitle": "Generating AI report (10–20s)",
  "rp.step1": "Reading everyone's responses",
  "rp.step2": "Spotting the themes",
  "rp.step3": "Weighing highlights and gaps",
  "rp.step4": "Drafting the next steps",
  "rp.seeMore": "Show {n} more",
  "rp.seeLess": "Show less",
  "rp.toneTitle": "Tone",
  ...
  "rp.noteTitle": "Note for the AI (optional)",
  "rp.notePlaceholder": "e.g. We were short-staffed this sprint — focus on process.",
  "rp.sec_themes": "Summary",
  "rp.sec_well": "What's going well",
  "rp.sec_improve": "What to improve",
  "rp.sec_actions": "Concrete next steps",
  "rp.sectionEmpty": "Nothing specific this time.",
  "os.discussionTitle": "Discussion",
  "os.shareTitle": "Shared view",
  "os.shareHint": "Select what people opening the shared link can see.",
  "os.optResponses": "Responses",
  "os.optReport": "AI report",
  "os.atLeastOne": "Can't uncheck this — viewers need at least one thing to see.",
  ...
  "am.loginTitle": "Welcome back",
  "am.loginHint": "Log in to pick up where you left off.",
  "am.registerTitle": "Create an account",
  "am.alreadyRegistered": "This email is already registered — log in instead.",
  "am.goLogin": "Log in instead",
...
const zh: Dict = {
  ...
  "ti.barTipMood": "{n}/{size} 人參與 · 評分 {mood}/5",
  "ti.barTipParticipation": "{n}/{size} 人參與",
  "ti.barTipResponses": "{n} 則回饋",
  "ti.noData": "還沒有資料。",
  "ti.pulse": "Team pulse",
  "ti.regen": "重新生成",
  ...
  "ti.step1": "正在彙整過去的 retro",
  "ti.step2": "正在追蹤團隊走向",
  "ti.step3": "正在找出反覆出現的主題",
  "ti.step4": "正在寫團隊近況",
  "ti.themes": "重複主題",
  ...
  "rp.stop": "停止",
  "rp.generatingTitle": "AI 報告生成中（約 10–20 秒）",
  "rp.step1": "正在讀大家的回答",
  "rp.step2": "正在抓重點主題",
  "rp.step3": "正在整理亮點與待改善",
  "rp.step4": "正在擬定調整方向",
  ...
  "rp.noteTitle": "給 AI 的備註（選填）",
  "rp.notePlaceholder": "例：這個 sprint 人力吃緊，請聚焦在流程面。",
  "rp.sec_themes": "一句話總結",
  "rp.sec_well": "正向亮點",
  "rp.sec_improve": "待改善點",
  "rp.sec_actions": "具體調整建議",
  "rp.sectionEmpty": "這次沒有特別提到的。",
  "os.discussionTitle": "討論",
  "os.shareTitle": "分享顯示內容",
  "os.shareHint": "選擇拿到連結的人打開結果頁時會看到的內容。",
  "os.optResponses": "原始回覆",
  "os.optReport": "AI 報告",
  "os.atLeastOne": "無法取消：至少要保留一個顯示項目。",
  ...
  "am.loginTitle": "歡迎回來",
  "am.loginHint": "登入後接續你的進度。",
  "am.registerTitle": "建立新帳號",
  "am.alreadyRegistered": "這個 email 已經註冊過了，請改用登入。",
  "am.goLogin": "改用登入",
  "am.resetTitle": "重設密碼",
