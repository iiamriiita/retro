...
const en: Dict = {
  ...
  "ti.chartTip":
    "Bar height = turnout (submissions / team size); colour = average mood (green good, gold ok, red low, grey = no rating).",
  "ti.barTipMood": "{date}: {pct}% turnout · mood {mood}/5",
...
const zh: Dict = {
  ...
  "ti.endedAll": "已結束 / 全部",
  "ti.chartTitle": "每場參與率",
  "ti.chartTip": "長度＝出席率（填寫人數／預計人數）；顏色＝平均氛圍（綠＝好、金＝中、紅＝差、灰＝無評分）。",
  "ti.barTipMood": "{date}：出席 {pct}% · 氛圍 {mood}/5",
