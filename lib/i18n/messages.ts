...
const en: Dict = {
  ...
  "os.shareBoth": "Report + responses",
  "os.shareBothDesc": "Viewers see the AI report and everyone's answers.",
  "os.shareReportOnly": "AI report only",
  "os.shareReportOnlyDesc": "Raw answers stay visible to you only.",
  "os.needReport": "Generate the AI report first.",
  "os.shareRawOnly": "Responses only",
  "os.shareRawOnlyDesc": "Viewers see the answers without the AI report.",
...
const zh: Dict = {
  ...
  "os.shareBoth": "報告＋原始回覆",
  "os.shareBothDesc": "訪客可以看到 AI 報告和大家的回答。",
  "os.shareReportOnly": "只顯示 AI 報告",
  "os.shareReportOnlyDesc": "原始回答只有你自己看得到。",
  "os.needReport": "要先生成 AI 報告才能選這個。",
  "os.shareRawOnly": "只顯示原始回覆",
  "os.shareRawOnlyDesc": "訪客只看到大家的回答，不含 AI 報告。",
